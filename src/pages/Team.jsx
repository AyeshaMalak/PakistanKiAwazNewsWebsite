...
export default function Team() {
    ...
    // Function to create URL-friendly slugs for profile links
    ...
    return (
        <div className="bg-white py-12 px-6 md:px-20">
            ...
            <section className="flex flex-col md:flex-row items-center gap-12 mb-16 bg-green-800 p-8 rounded-xl shadow-lg">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    {members.map((member, index) => (
                        <div
                            key={index}
                            className="bg-green-800 rounded-xl shadow-lg overflow-hidden text-center p-4 transform hover:-translate-y-2 hover:shadow-2xl transition duration-300"
                        >
                            <div className="overflow-hidden rounded-xl">
                                <img
                                    src={member.image}
                                    alt={member.name}
                                    className="w-full h-64 md:h-72 object-cover rounded-xl transform hover:scale-105 transition duration-500"
                                />
                            </div>
